...
class RC4:
    def __init__(self, key = None):
        ...
        # in python3, must make this into a list or you get a
        # range object does not support assignment error
    ...
    def binaryDecrypt(self, data):
        ...
        # for python3, change this xrange to range
...
if __name__ == '__main__':
    ...
    # If we want to run a real bind DNS server in parallel with this,
    # we can change this to run on 5353 and then forward certain requests
    # from the bind server to this one

    udps = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)

    listen_addr = '127.0.0.1'
    listen_port = 53535
    udps.bind((listen_addr,listen_port))
    print(color(f"[*] DNS server listening on port {listen_addr}:{listen_port}"))
